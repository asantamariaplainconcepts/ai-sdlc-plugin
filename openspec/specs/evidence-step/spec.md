# evidence-step Specification

## Purpose
Launching nothing, mutating nothing: the fourth review step presents the runs recorded against a worktree as read-only evidence — exits, costs, transcripts and triggers on the table, each absence its own sentence.
